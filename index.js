...
async function listAll(owner, title, author, restrictToRepos, { ignoreChecks = false } = {}) {
...
listAll(process.argv[2], process.argv[3], process.argv[4], restrictToRepos, { ignoreChecks })
